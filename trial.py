...
def vgg_face_dag(weights_path=None, finetune=False, **kwargs):
    """
...
'''def run(opt):
    ...
    datatrain, data_loader ,data_loader_a, dataset_size = get_loader(opt,classname = opt.cname)
    model = create_model(opt)
    model.setup(opt)
    # create a website
